      ...
      <div className="grid grid-cols-1 md:grid-cols-2 border-2 border-primary">
        <div className="flex flex-col">
          <div className="flex flex-col gap-4 border border-primary p-10">
            <h2 className="scroll-m-20 text-3xl font-semibold tracking-tight mb-4">Follow for updates</h2>
            <div className="flex flex-row gap-6 items-center">
              <Button className="w-fit rounded-none">
                <a className="flex flex-row gap-2 items-center" href="https://x.com/unitmetalHQ" target='blank'>Go to X account <ExternalLink className="w-4 h-4" /></a>
              </Button>
              <a className="flex flex-row gap-2 items-center underline underline-offset-2" target='blank' href="https://t.me/unitmetalhq"><Rss className="w-4 h-4" />Telegram Channel</a>
            </div>
          </div>
        ...
        <div className="flex flex-col">
          <div className="grow border border-primary p-10">
            <h2 className="scroll-m-20 text-3xl font-semibold tracking-tight">Want to leave feedbacks?</h2>
            <p className="leading-7 not-first:mt-6 mb-6">We are always looking for feedback to improve the product. Please feel free to reach out to us.</p>
            <a className="flex flex-row gap-2 items-center dark:text-blue-400 text-blue-500 underline underline-offset-4" href="https://github.com/unitmetalhq" target="_blank">
